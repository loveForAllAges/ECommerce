...
const keyframes = require('tailwindcss-animatecss/src/keyframes/keyframes');
const keyframesLightSpeed = require('tailwindcss-animatecss/src/keyframes/lightspeed');
const keyframesFlip = require('tailwindcss-animatecss/src/keyframes/flip');
const keyframesRotateIn = require('tailwindcss-animatecss/src/keyframes/rotateIn');
const keyframesRotateOut = require('tailwindcss-animatecss/src/keyframes/rotateOut');
const keyframesRoll = require('tailwindcss-animatecss/src/keyframes/roll');
const keyframesZoomIn = require('tailwindcss-animatecss/src/keyframes/zoomIn');
const keyframesZoomOut = require('tailwindcss-animatecss/src/keyframes/zoomOut');
const keyframesBounceIn = require('tailwindcss-animatecss/src/keyframes/bounceIn');
const keyframesBounceOut = require('tailwindcss-animatecss/src/keyframes/bounceOut');
const keyframesSlideIn = require('tailwindcss-animatecss/src/keyframes/slideIn');
const keyframesSlideOut = require('tailwindcss-animatecss/src/keyframes/slideOut');
const keyframesFadeIn = require('tailwindcss-animatecss/src/keyframes/fadeIn');
const keyframesFadeOut = require('tailwindcss-animatecss/src/keyframes/fadeOut');
const keyframesBackIn = require('tailwindcss-animatecss/src/keyframes/backIn');
const keyframesBackOut = require('tailwindcss-animatecss/src/keyframes/backOut');
